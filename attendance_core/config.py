...
OVERTIME_BREAK_BONUS_MINUTES_PER_HOUR = 5
TARDINESS_POLICY_ENABLED_DEFAULT = 1
TARDINESS_POLICY_STEP_ONE_MAX_MINUTES = 15
TARDINESS_POLICY_STEP_TWO_MAX_MINUTES = 30
TARDINESS_POLICY_STEP_THREE_MAX_MINUTES = 45
TARDINESS_POLICY_STEP_ONE_SHIFT_DEDUCTION_MINUTES = 15
TARDINESS_POLICY_STEP_TWO_SHIFT_DEDUCTION_MINUTES = 30
TARDINESS_POLICY_STEP_THREE_SHIFT_DEDUCTION_MINUTES = 60
TARDINESS_POLICY_STEP_ONE_BREAK_DEDUCTION_MINUTES = 15
